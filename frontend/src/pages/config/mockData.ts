...
export const forceUpdateRules: ForceUpdateRule[] = [
  {
    ...
    message: "Please update ADmaps to the latest version for security improvements and new features.",
    updateUrl: "https://play.google.com/store/apps/details?id=ae.admaps.app",
    isBlocking: true,
    enabled: true,
  ...
  },
  {
    ...
    minVersionName: "3.4.0",
    title: "Update Required",
    message: "A new version of ADmaps is available. Please update to continue using the app.",
    updateUrl: "https://apps.apple.com/ae/app/admaps/id123456789",
    isBlocking: true,
    enabled: true,
    updatedAt: "2026-03-15T08:00:00Z",
  },
